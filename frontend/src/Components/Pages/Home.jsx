          ...
          <div className=" m-0 d-flex flex-column align-items-center justify-content-between">
            <div className="bg-dod-blue text-white p-5">
              ...
              <p>
                ...
                appointments in days. Telehealth you can trust.
              </p>
            </div>
            <div className="w-100">
              <Link to="/">
      ...
      <div className="container mx-auto">
        <div className="row">
          <div className="col text-start">
            <p>
              Meet with an online therapist or psychiatrist when and where it
              works for you.
            </p>
          </div>
        ...
        <div className="row">
          ...
          <div className="col">
            <p>
              ...
              with a <Link to="/">therapist or psychiatrist</Link> this week.
            </p>
          </div>
          ...
          <div className="row gap-5">
            <div className="col-md-4 card card-width">
              <Link to="/">
                <h3 className="card-title card-link">Cold & Flue</h3>
              </Link>
              <ul>
                <li>Cough</li>
                <li>Headaches</li>
